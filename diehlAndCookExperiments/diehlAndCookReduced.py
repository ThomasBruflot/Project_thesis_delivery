...
class DiehlAndCook2015Reduced(Network):
    # language=rst
    """
    Implements the spiking neural network architecture from `(Diehl & Cook 2015)
    <https://www.frontiersin.org/articles/10.3389/fncom.2015.00099/full>`_.
    Modified to have a reduced size to see performance drop compared to memory estimates.
    """
    ...
    def __init__(
        ...
        # language=rst
        """
        Constructor for class ``DiehlAndCook2015Reduced``.
...
# Build network.
network = DiehlAndCook2015Reduced(
    n_inpt=784,
    n_neurons=1600 ,
    exc=exc,
    inh=inh,
